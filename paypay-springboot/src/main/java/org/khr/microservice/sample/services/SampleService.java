package org.khr.microservice.sample.services;
...
import org.khr.microservice.sample.model.QrCodeRequest;
    ...
    public PaymentDetails fetchPaymentDetails(PaymentApi paymentApi, String merchantId) {
        return Polling
            ...
            .run(() -> {
                ...
                if (paymentDetails.getData() != null && (
                    paymentDetails.getData().getStatus() == PaymentState.StatusEnum.COMPLETED
