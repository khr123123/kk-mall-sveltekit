...
const brandsData = [
	{
		...
		description:
			'革新的なテクノロジー製品を提供する世界的なブランド。iPhone、Mac、iPadなど、高品質な製品で知られています。',
	...
	},
	{
		...
		description:
			'エレクトロニクスとエンターテインメントの融合。カメラ、オーディオ、ゲーム機など多彩な製品を展開。',
		category: 'electronics',
		isPopular: true,
		rating: 4.6,
		followers: 38000,
	...
	},
	{
		...
		description:
			'スポーツウェアとフットウェアのグローバルリーダー。革新的なデザインと高性能を追求。',
		category: 'fashion',
		isPopular: true,
		rating: 4.9,
		followers: 65000,
	...
	},
	{
		...
		description:
			'スポーツとライフスタイルの融合ブランド。三本線のロゴで有名なドイツのスポーツメーカー。',
		category: 'fashion',
		isPopular: true,
		rating: 4.8,
		followers: 58000,
	...
	},
	{
		...
		description:
			'高品質で手頃な価格のライフウェア。シンプルで機能的なデザインが特徴の日本ブランド。',
		category: 'fashion',
		isPopular: true,
		rating: 4.5,
		followers: 52000,
	...
	},
	{
		...
		description:
			'革新的な家電製品のパイオニア。掃除機、ヘアドライヤー、空気清浄機など独自技術を持つ。',
		category: 'home',
		isPopular: true,
		rating: 4.7,
		followers: 42000,
	...
	},
	{
		...
		description:
			'世界を魅了するゲームとエンターテインメント。マリオ、ゼルダなど人気キャラクターを持つ。',
		category: 'electronics',
		isPopular: true,
		rating: 4.9,
		followers: 55000,
	...
	},
	{
		...
		description:
			'イメージング技術のリーディングカンパニー。カメラ、プリンターで世界的なシェアを持つ。',
		category: 'electronics',
		isPopular: false,
		rating: 4.6,
		followers: 28000,
...
const productsData = {
	Apple: [
		{
			...
			description:
				'最新のA17 Proチップ搭載。チタニウムデザインで軽量化を実現。プロ向けの高性能カメラシステム。',
			price: 159800,
		...
		},
		{
			...
			description:
				'驚異的なパフォーマンスと最大18時間のバッテリー駆動時間。薄型軽量で持ち運びに最適。',
			price: 164800,
		...
		},
		{
			...
			description:
				'アクティブノイズキャンセリング搭載。空間オーディオで没入感のある音楽体験。USB-C充電対応。',
			price: 39800,
			originalPrice: 39800,
			category: 'オーディオ',
			stock: 100,
	...
	Sony: [
		...
		},
		{
			...
			description:
				'写真と動画の両方で優れたパフォーマンス。プロフェッショナル向けフルサイズミラーレス。',
			price: 329000,
	...
	Dyson: [
		...
		},
		{
			...
			description:
				'髪を素早く美しく乾かす高性能ドライヤー。温度を素早く測定し、過度の熱ダメージを防止。',
			price: 45760,
			originalPrice: 52800,
			category: '美容家電',
			stock: 60,
